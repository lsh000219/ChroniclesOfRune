...
public class StoreManager : Singleton<StoreManager>, IUIInterface
{
    ...
    protected override void Awake()
    {
        ...
        if (Instance == this)
        {
            ...
            EventBus.Subscribe(LoadState.LoadComplete, SceneLoadEvnet);
        }
    ...
    private void OnDestroy()
    {
        if (Instance == this)
        {
            EventBus.Unsubscribe(LoadState.LoadComplete, SceneLoadEvnet);
        }
    }
    public void SceneLoadEvnet(object obj)
    {
        Logger.Log("??");
